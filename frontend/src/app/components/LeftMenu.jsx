    ...
    <div className={`menu-wrapper font-mono ${className}`}>
        ...
        <ul className='actions-menu text-center flex flex-col justify-between text-xl h-5/6'>
            <div className="h-full flex flex-col justify-center">
              <li className='actions-menu__item'><Link href="/appointments">Appointments</Link></li>
              <li className='actions-menu__item'><Link href="/medications">Medication Management</Link></li>
              <li className='actions-menu__item'><Link href="/symptomsCheck">Symptom Checker</Link></li>
            </div>
